"""
DEPRECATED: This file is deprecated. Use migration system instead.

For creating tables use:
- python database/migration_manager.py (apply migrations)
- python database/init_database.py (full initialization)

This file is kept for backward compatibility.
New code should use the migration system in migrations/ folder.
"""
...
def create_all_tables():
    """
    DEPRECATED: Use migration system instead
    
    This function creates all base tables directly.
    For new projects, use: python -m database.init_database
    """
    logger.warning("⚠️ DEPRECATED: Use migration system instead of create_all_tables()")
    logger.info("Run: python -m database.init_database")
    ...
    try:
        ...
        logger.warning("⚠️ Consider using migration system for future changes")
...
if __name__ == "__main__":
    logger.warning("="*60)
    logger.warning("⚠️ DEPRECATED FILE")
    logger.warning("Use: python -m database.init_database")
    logger.warning("="*60)
    create_all_tables()
